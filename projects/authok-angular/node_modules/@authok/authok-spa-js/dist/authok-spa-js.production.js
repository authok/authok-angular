!(function (e, t) {
  ...
  var f,
    ...
    N = C({}.isPrototypeOf),
    Y = V('navigator', 'userAgent') || '',
    D = p.process,
    z = p.Deno,
    B = (D && D.versions) || (z && z.version),
    J = B && B.v8;
  J && (d = (f = J.split('.'))[0] > 0 && f[0] < 4 ? 1 : +(f[0] + f[1])),
    !d &&
      Y &&
      (!(f = Y.match(/Edge\/(\d+)/)) || f[1] >= 74) &&
      (f = Y.match(/Chrome\/(\d+)/)) &&
      (d = +f[1]);
  var M = d,
    H =
    ...
    me = C((1).toString),
    ge = function (e) {
      return 'Symbol(' + (void 0 === e ? '' : e) + ')_' + me(++ye + ve, 36);
    },
    be = le('wks'),
    we = p.Symbol,
    Se = we && we.for,
    ke = q ? we : (we && we.withoutSetter) || ge,
    _e = function (e) {
      if (!pe(be, e) || (!H && 'string' != typeof be[e])) {
        var t = 'Symbol.' + e;
        H && pe(we, e) ? (be[e] = we[e]) : (be[e] = q && Se ? Se(t) : ke(t));
      }
      return be[e];
    },
    Ie = p.TypeError,
    ...
    xe = p.document,
    Ce = G(xe) && G(xe.createElement),
    Ae = function (e) {
      return Ce ? xe.createElement(e) : {};
    },
    Re =
      !v &&
      !y(function () {
    ...
    Ue = {
      f: v
        ...
        : function (e, t) {
            ...
            if (pe(e, t)) return I(!b(_.f, e, t), e[t]);
          },
    },
    Pe =
      v &&
    ...
    We = function (e) {
      if (G(e)) return e;
      throw Fe(Ke(e) + ' is not an object');
    },
    Le = p.TypeError,
    ...
    Ye = {
      f: v
        ? Pe
          ? function (e, t, n) {
              if (
                ...
                r &&
                  ...
                  ((e[t] = n.value),
                  (n = {
                    configurable: Ve in n ? n.configurable : r.configurable,
                    enumerable: Xe in n ? n.enumerable : r.enumerable,
                    writable: !1,
                  }));
              }
              return Ze(e, t, n);
          ...
          : Ze
        : function (e, t, n) {
            if ((We(e), (t = Ee(t)), We(n), Re))
              try {
                return Ze(e, t, n);
              } catch (e) {}
            if ('get' in n || 'set' in n) throw Le('Accessors not supported');
            return 'value' in n && (e[t] = n.value), e;
          },
    },
    De = v
      ? function (e, t, n) {
          return Ye.f(e, t, I(1, n));
        }
      : function (e, t, n) {
          return (e[t] = n), e;
        },
    ze = C(Function.toString);
  Z(ue.inspectSource) ||
  ...
  var Be,
    ...
    He = ue.inspectSource,
    qe = p.WeakMap,
    Qe = Z(qe) && /native code/.test(He(qe)),
    $e = le('keys'),
    et = function (e) {
      return $e[e] || ($e[e] = ge(e));
    },
    ...
    ot = p.WeakMap;
  if (Qe || ue.state) {
    var it = ue.state || (ue.state = new ot()),
      at = C(it.get),
      ct = C(it.has),
      st = C(it.set);
    (Be = function (e, t) {
      if (ct(it, e)) throw new rt(nt);
      return (t.facade = e), st(it, e, t), t;
    }),
      (Je = function (e) {
        return at(it, e) || {};
      }),
    ...
    (tt[ut] = !0),
      (Be = function (e, t) {
        if (pe(e, ut)) throw new rt(nt);
        return (t.facade = e), De(e, ut, t), t;
      }),
      (Je = function (e) {
        return pe(e, ut) ? e[ut] : {};
      }),
  ...
  var lt = {
      ...
      has: Me,
      enforce: function (e) {
        return Me(e) ? Je(e) : Be(e, {});
      },
      getterFor: function (e) {
        return function (t) {
          var n;
          if (!G(t) || (n = Je(t)).type !== e)
    ...
    dt = v && Object.getOwnPropertyDescriptor,
    ht = pe(ft, 'name'),
    pt = {
      EXISTS: ht,
      PROPER: ht && 'something' === function () {}.name,
      CONFIGURABLE: ht && (!v || (v && dt(ft, 'name').configurable)),
    },
    yt = l(function (e) {
      var t = pt.CONFIGURABLE,
        n = lt.get,
        r = lt.enforce,
      ...
      (e.exports = function (e, n, i, a) {
        ...
        Z(i) &&
          ...
          (!pe(i, 'name') || (t && i.name !== f)) && De(i, 'name', f),
          (c = r(i)).source ||
        ...
        return (Z(this) && n(this).source) || He(this);
      });
    }),
    vt = Math.ceil,
    mt = Math.floor,
    ...
    Ct = function (e, t) {
      var n,
        ...
        o = 0,
        i = [];
      for (n in r) !pe(tt, n) && pe(r, n) && xt(i, n);
      for (; t.length > o; ) pe(r, (n = t[o++])) && (~Et(i, n) || xt(i, n));
      return i;
    },
    At = [
      'constructor',
    ...
    Ft = function (e, t, n) {
      for (var r = Kt(t), o = Ye.f, i = Ue.f, a = 0; a < r.length; a++) {
        var c = r[a];
        pe(e, c) || (n && pe(n, c)) || o(e, c, i(t, c));
      }
    },
    Wt = /#|\.prototype\./,
    Lt = function (e, t) {
      var n = Gt[Zt(e)];
      return n == Vt || (n != Xt && (Z(t) ? y(t) : !!t));
    },
    Zt = (Lt.normalize = function (e) {
    ...
    Dt = function (e, t) {
      ...
      if ((n = s ? p : u ? p[c] || ce(c, {}) : (p[c] || {}).prototype))
        for (r in t) {
          if (
            ((i = t[r]),
            (o = e.noTargetGet ? (a = Yt(n, r)) && a.value : n[r]),
            !Nt(s ? r : c + (u ? '.' : '#') + r, e.forced) && void 0 !== o)
          ) {
            if (typeof i == typeof o) continue;
            Ft(i, o);
          }
          (e.sham || (o && o.sham)) && De(i, 'sham', !0), yt(n, r, i, e);
        }
    },
    zt = {};
  zt[_e('toStringTag')] = 'z';
  var Bt,
    Jt = '[object z]' === String(zt),
    Mt = _e('toStringTag'),
    Ht = p.Object,
    qt =
      'Arguments' ==
    ...
    rn = function (e) {
      if (
        (function (e) {
          var t;
          return G(e) && (void 0 !== (t = e[tn]) ? !!t : 'RegExp' == j(e));
        })(e)
      )
        throw nn("The method doesn't accept regular expressions");
      return e;
    },
    on = _e('match'),
    an = function (e) {
    ...
    fn = an('startsWith'),
    dn = !(
      fn || ((Bt = cn(String.prototype, 'startsWith')), !Bt || Bt.writable)
    );
  Dt(
    { target: 'String', proto: !0, forced: !dn && !fn },
    {
      startsWith: function (e) {
        var t = en(W(this));
        rn(e);
        var n = _t(ln(arguments.length > 1 ? arguments[1] : void 0, t.length)),
          r = en(e);
        return sn ? sn(t, r, n) : un(t, n, n + r.length) === r;
      },
    }
  );
  var hn = function (e, t) {
  ...
  var pn =
    ...
    yn = function (e, t, n) {
      var r = Ee(t);
      r in e ? Ye.f(e, r, I(0, n)) : (e[r] = n);
    },
    vn = function () {},
    mn = [],
    gn = V('Reflect', 'construct'),
  ...
  var In,
    ...
    Fn = function (e) {
      if (!G(e)) return !1;
      var t = e[An];
      return void 0 !== t ? !!t : pn(e);
    };
  Dt(
    { target: 'Array', proto: !0, forced: !Pn || !Kn },
    {
      concat: function (e) {
        var t,
          n,
        ...
        for (t = -1, r = arguments.length; t < r; t++)
          if (Fn((i = -1 === t ? a : arguments[t]))) {
            if (s + (o = It(i)) > Rn) throw Un(jn);
            for (n = 0; n < o; n++, s++) n in i && yn(c, s, i[n]);
          } else {
            if (s >= Rn) throw Un(jn);
            yn(c, s++, i);
          }
  ...
  Jt || yt(Object.prototype, 'toString', Wn, { unsafe: !0 });
  var Ln,
    ...
    Yn =
      v && !Pe
        ...
        : function (e, t) {
            We(e);
            for (var n, r = L(t), o = Nn(t), i = o.length, a = 0; i > a; )
              Ye.f(e, (n = o[a++]), r[n]);
            return e;
          },
    Dn = { f: Yn },
    zn = V('document', 'documentElement'),
    Bn = et('IE_PROTO'),
    Jn = function () {},
    Mn = function (e) {
        ...
        'undefined' != typeof document
          ? document.domain && Ln
            ...
            : (((t = Ae('iframe')).style.display = 'none'),
              ...
              e.write(Mn('document.F=Object')),
              e.close(),
              e.F)
          : Hn(Ln);
      for (var n = At.length; n--; ) delete qn.prototype[At[n]];
      return qn();
    };
  tt[Bn] = !0;
  var Qn =
    ...
    or = {
      f: function (e) {
        return nr && 'Window' == j(e) ? rr(e) : tr(L(e));
      },
    },
    ir = C([].slice),
    ar = { f: _e },
    ...
    sr = Ye.f,
    ur = function (e) {
      var t = cr.Symbol || (cr.Symbol = {});
      pe(t, e) || sr(t, e, { value: ar.f(e) });
    },
    lr = Ye.f,
    fr = _e('toStringTag'),
    dr = function (e, t, n) {
      e && !n && (e = e.prototype),
        e && !pe(e, fr) && lr(e, fr, { configurable: !0, value: t });
    },
    hr = C(C.bind),
    pr = function (e, t) {
      return (
    ...
    Pr = le('symbols'),
    Kr = le('op-symbols'),
    Fr = le('string-to-symbol-registry'),
    Wr = le('symbol-to-string-registry'),
    Lr = le('wks'),
    Zr = !Er || !Er.prototype || !Er.prototype.findChild,
    Gr =
      v &&
      y(function () {
        return (
        ...
        ? function (e, t, n) {
            var r = Cr(_r, t);
            r && delete _r[t], Ar(e, t, n), r && e !== _r && Ar(_r, t, r);
          }
        : Ar,
    Xr = function (e, t) {
      var n = (Pr[e] = Qn(Tr));
      return (
        Sr(n, { type: br, tag: e, description: t }), v || (n.description = t), n
      );
    },
    Vr = function (e, t, n) {
      e === _r && Vr(Kr, t, n), We(e);
      ...
      return (
        ...
        pe(Pr, r)
          ? (n.enumerable
              ? (pe(e, gr) && e[gr][r] && (e[gr][r] = !1),
                (n = Qn(n, { enumerable: I(0, !1) })))
              : (pe(e, gr) || Ar(e, gr, I(1, {})), (e[gr][r] = !0)),
            Gr(e, r, n))
          : Ar(e, r, n)
      );
    },
    ...
    Yr = function (e) {
      var t = Ee(e),
        n = b(jr, this, t);
      return (
        !(this === _r && pe(Pr, t) && !pe(Kr, t)) &&
        (!(n || !pe(this, t) || !pe(Pr, t) || (pe(this, gr) && this[gr][t])) ||
          n)
      );
    },
    Dr = function (e, t) {
      var n = L(e),
        r = Ee(t);
      if (n !== _r || !pe(Pr, r) || pe(Kr, r)) {
        var o = Cr(n, r);
        return (
          !o || !pe(Pr, r) || (pe(n, gr) && n[gr][r]) || (o.enumerable = !0), o
        );
      }
    },
    zr = function (e) {
  ...
  if (
    (H ||
      ((Ir = function () {
        if (N(Tr, this)) throw Or('Symbol is not a constructor');
        var e =
          ...
          n = function (e) {
            this === _r && b(n, Kr, e),
              pe(this, gr) && pe(this[gr], t) && (this[gr][t] = !1),
              Gr(this, t, I(1, e));
          };
        return v && Zr && Gr(_r, t, { configurable: !0, set: n }), Xr(t, e);
      }),
      (Tr = Ir.prototype),
      yt(Tr, 'toString', function () {
        return kr(this).tag;
      }),
      yt(Ir, 'withoutSetter', function (e) {
        return Xr(ge(e), e);
      }),
      (_.f = Yr),
      (Ye.f = Vr),
      ...
      v &&
        (Ar(Tr, 'description', {
          configurable: !0,
          get: function () {
            return kr(this).description;
          },
        }),
        yt(_r, 'propertyIsEnumerable', Yr, { unsafe: !0 }))),
    Dt({ global: !0, wrap: !0, forced: !H, sham: !H }, { Symbol: Ir }),
    mr(Nn(Lr), function (e) {
      ur(e);
    }),
    Dt(
      { target: br, stat: !0, forced: !H },
      {
        for: function (e) {
          var t = en(e);
          if (pe(Fr, t)) return Fr[t];
          var n = Ir(t);
          return (Fr[t] = n), (Wr[n] = t), n;
        },
        keyFor: function (e) {
          if (!$(e)) throw Or(e + ' is not a symbol');
          if (pe(Wr, e)) return Wr[e];
        },
        useSetter: function () {
          Zr = !0;
        },
    ...
    Dt(
      ...
      {
        create: function (e, t) {
          return void 0 === t ? Qn(e) : Nr(Qn(e), t);
        },
        defineProperty: Vr,
        defineProperties: Nr,
    ...
    Dt(
      ...
      { getOwnPropertyNames: zr, getOwnPropertySymbols: Br }
    ),
    Dt(
      {
        target: 'Object',
        ...
        stringify: function (e, t, n) {
          ...
          if ((G(t) || void 0 !== e) && !$(e))
            return (
              pn(t) ||
                (t = function (e, t) {
                  if ((Z(o) && (t = b(o, this, e, t)), !$(t))) return t;
                }),
              (r[1] = t),
              Vn(xr, null, r)
            );
  ...
  dr(Ir, br), (tt[gr] = !0), ur('asyncIterator');
  var Hr = Ye.f,
    qr = p.Symbol,
    Qr = qr && qr.prototype;
  if (v && Z(qr) && (!('description' in Qr) || void 0 !== qr().description)) {
    var $r = {},
      eo = function () {
        var e =
            arguments.length < 1 || void 0 === arguments[0]
              ? void 0
              : en(arguments[0]),
          t = N(Qr, this) ? new qr(e) : void 0 === e ? qr() : qr(e);
        return '' === e && ($r[t] = !0), t;
      };
    Ft(eo, qr), (eo.prototype = Qr), (Qr.constructor = eo);
    var to = 'Symbol(test)' == String(qr('test')),
      no = C(Qr.toString),
      ro = C(Qr.valueOf),
      oo = /^Symbol\((.*)\)[^)]+$/,
      io = C(''.replace),
    ...
    Hr(Qr, 'description', {
      ...
      get: function () {
        var e = ro(this),
          t = no(e);
        if (pe($r, e)) return '';
        var n = to ? ao(t, 7, -1) : io(t, oo, '$1');
        return '' === n ? void 0 : n;
      },
    }),
      Dt({ global: !0, forced: !0 }, { Symbol: eo });
  }
  ur('hasInstance'),
    ur('isConcatSpreadable'),
    ur('iterator'),
    ur('match'),
    ur('matchAll'),
    ur('replace'),
  ...
  [].keys &&
    ('next' in (uo = [].keys())
      ? (so = wo(wo(uo))) !== Object.prototype && (co = so)
      : (ko = !0));
  var _o =
    null == co ||
    y(function () {
      var e = {};
      return co[So].call(e) !== e;
    });
  _o && (co = {}),
    Z(co[So]) ||
      yt(co, So, function () {
  ...
  var Io = { IteratorPrototype: co, BUGGY_SAFARI_ITERATORS: ko },
    To = {},
    Oo = Io.IteratorPrototype,
    Eo = function () {
      return this;
    },
    xo = p.String,
            ...
            return function (n, r) {
              return (
                ...
                (function (e) {
                  ...
                  throw Co("Can't set " + xo(e) + ' as a prototype');
                })(r),
    ...
    Ro = pt.PROPER,
    jo = pt.CONFIGURABLE,
    Uo = Io.IteratorPrototype,
    Po = Io.BUGGY_SAFARI_ITERATORS,
    Ko = _e('iterator'),
    Fo = 'keys',
    Wo = 'values',
    Lo = 'entries',
    ...
    Go = function (e, t, n, r, o, i, a) {
      !(function (e, t, n, r) {
        var o = t + ' Iterator';
        (e.prototype = Qn(Oo, { next: I(+!r, n) })), dr(e, o, !1), (To[o] = Eo);
      })(n, t, r);
      var c,
        s,
        u,
        ...
        d = !1,
        h = e.prototype,
        p = h[Ko] || h['@@iterator'] || (o && h[o]),
        y = (!Po && p) || l(o),
        v = ('Array' == t && h.entries) || p;
      if (
        (v &&
          (c = wo(v.call(new e()))) !== Object.prototype &&
          c.next &&
          (wo(c) !== Uo && (Ao ? Ao(c, Uo) : Z(c[Ko]) || yt(c, Ko, Zo)),
          dr(c, f, !0)),
        Ro &&
          o == Wo &&
          p &&
        ...
        if (((s = { values: l(Wo), keys: i ? y : l(Fo), entries: l(Lo) }), a))
          for (u in s) (Po || d || !(u in h)) && yt(h, u, s[u]);
        else Dt({ target: t, proto: !0, forced: Po || d }, s);
      return h[Ko] !== y && yt(h, Ko, y, { name: o }), (To[t] = y), s;
    },
    Xo = yo.charAt,
    Vo = 'String Iterator',
    No = lt.set,
  ...
  Go(
    ...
    'String',
    function (e) {
      No(this, { type: Vo, string: en(e), index: 0 });
    },
    function () {
      var e,
        t = Yo(this),
      ...
      return r >= n.length
        ? { value: void 0, done: !0 }
        : ((e = Xo(n, r)), (t.index += e.length), { value: e, done: !1 });
    }
  );
  var Do = function (e, t, n) {
    ...
    Jo = Array.prototype,
    Mo = function (e) {
      return void 0 !== e && (To.Array === e || Jo[Bo] === e);
    },
    Ho = _e('iterator'),
    qo = function (e) {
      if (null != e) return oe(e, Ho) || oe(e, '@@iterator') || To[Qt(e)];
    },
    Qo = p.TypeError,
    $o = function (e, t) {
      var n = arguments.length < 2 ? qo(e) : t;
      if (re(n)) return We(b(n, e));
      throw Qo(te(e) + ' is not iterable');
    },
    ei = p.Array,
    ti = _e('iterator'),
    ni = !1;
    ...
    { target: 'Array', stat: !0, forced: ai },
    {
      from: function (e) {
        var t = de(e),
          ...
          i = void 0 !== o;
        i && (o = pr(o, r > 2 ? arguments[2] : void 0));
        var a,
          c,
          s,
          u,
          ...
          h = 0;
        if (!d || (this == ei && Mo(d)))
          for (a = It(t), c = n ? new this(a) : ei(a); a > h; h++)
            (f = i ? o(t[h], h) : t[h]), yn(c, h, f);
        else
          for (
            l = (u = $o(t, d)).next, c = n ? new this() : [];
            !(s = b(l, u)).done;
            h++
          )
            (f = i ? zo(u, o, [s.value, h], !0) : s.value), yn(c, h, f);
        return (c.length = h), c;
      },
    }
  ),
  ...
  var ci,
    si,
    ui,
    li = 'undefined' != typeof ArrayBuffer && 'undefined' != typeof DataView,
    fi = Ye.f,
    di = p.Int8Array,
    hi = di && di.prototype,
    pi = p.Uint8ClampedArray,
    yi = pi && pi.prototype,
    vi = di && wo(di),
    mi = hi && wo(hi),
    gi = Object.prototype,
    bi = p.TypeError,
    wi = _e('toStringTag'),
    Si = ge('TYPED_ARRAY_TAG'),
    ki = ge('TYPED_ARRAY_CONSTRUCTOR'),
    _i = li && !!Ao && 'Opera' !== Qt(p.opera),
    Ii = !1,
    Ti = {
      Int8Array: 1,
      Uint8Array: 1,
    ...
    Ei = function (e) {
      if (!G(e)) return !1;
      var t = Qt(e);
      return pe(Ti, t) || pe(Oi, t);
    };
  for (ci in Ti)
    (ui = (si = p[ci]) && si.prototype) ? De(ui, ki, si) : (_i = !1);
  for (ci in Oi) (ui = (si = p[ci]) && si.prototype) && De(ui, ki, si);
  if (
    (!_i || !Z(vi) || vi === Function.prototype) &&
    ((vi = function () {
      throw bi('Incorrect invocation');
    }),
    _i)
  )
    for (ci in Ti) p[ci] && Ao(p[ci], vi);
  if ((!_i || !mi || mi === gi) && ((mi = vi.prototype), _i))
    for (ci in Ti) p[ci] && Ao(p[ci].prototype, mi);
  if ((_i && wo(yi) !== mi && Ao(yi, mi), v && !pe(mi, wi)))
    for (ci in ((Ii = !0),
    fi(mi, wi, {
      get: function () {
        return G(this) ? this[Si] : void 0;
      },
    }),
    Ti))
      p[ci] && De(p[ci], Si, ci);
  var xi = {
      NATIVE_ARRAY_BUFFER_VIEWS: _i,
      TYPED_ARRAY_CONSTRUCTOR: ki,
      TYPED_ARRAY_TAG: Ii && Si,
      aTypedArray: function (e) {
        if (Ei(e)) return e;
        throw bi('Target is not a typed array');
      },
      aTypedArrayConstructor: function (e) {
        if (Z(e) && (!Ao || N(vi, e))) return e;
        throw bi(te(e) + ' is not a typed array constructor');
      },
      exportTypedArrayMethod: function (e, t, n, r) {
        if (v) {
          ...
          (mi[e] && !n) || yt(mi, e, n ? t : (_i && hi[e]) || t, r);
        }
      },
      exportTypedArrayStaticMethod: function (e, t, n) {
        ...
        if (v) {
          if (Ao) {
            ...
            if (vi[e] && !n) return;
            try {
              return yt(vi, e, n ? t : (_i && vi[e]) || t);
            } catch (e) {}
          }
          for (r in Ti) !(o = p[r]) || (o[e] && !n) || yt(o, e, t);
        }
      },
      isView: function (e) {
        if (!G(e)) return !1;
        var t = Qt(e);
        return 'DataView' === t || pe(Ti, t) || pe(Oi, t);
      },
      isTypedArray: Ei,
      TypedArray: vi,
      TypedArrayPrototype: mi,
    },
    Ci = p.TypeError,
    Ai = _e('species'),
    Ri = function (e, t) {
      var n,
        r = We(e).constructor;
      return void 0 === r || null == (n = We(r)[Ai])
        ? t
        : (function (e) {
            if (Tn(e)) return e;
            throw Ci(te(e) + ' is not a constructor');
          })(n);
    },
    ji = xi.TYPED_ARRAY_CONSTRUCTOR,
    Ui = xi.aTypedArrayConstructor,
    Pi = xi.aTypedArray;
  (0, xi.exportTypedArrayMethod)(
    'slice',
    function (e, t) {
      for (
        var n,
  ...
  var Ki = _e('unscopables'),
    Fi = Array.prototype;
  null == Fi[Ki] && Ye.f(Fi, Ki, { configurable: !0, value: Qn(null) });
  var Wi = function (e) {
      Fi[Ki][e] = !0;
    },
    Li = Ot.includes;
  ...
  var Zi = C(''.indexOf);
  Dt(
    { target: 'String', proto: !0, forced: !an('includes') },
    {
      includes: function (e) {
        return !!~Zi(
          en(W(this)),
  ...
  Go(
    ...
    'Array',
    function (e, t) {
      Vi(this, { type: Xi, target: L(e), index: 0, kind: t });
    },
    function () {
      var e = Ni(this),
        t = e.target,
  ...
  var Yi = (To.Arguments = To.Array);
  if ((Wi('keys'), Wi('values'), Wi('entries'), v && 'values' !== Yi.name))
    try {
      Gi(Yi, 'name', { value: 'values' });
    } catch (e) {}
  var Di = y(function () {
    ...
    zi = Object.isExtensible,
    Bi =
      y(function () {
        zi(1);
      }) || Di
        ? function (e) {
            return !!G(e) && (!Di || 'ArrayBuffer' != j(e)) && (!zi || zi(e));
          }
        : zi,
    Ji = !y(function () {
    ...
    Mi = l(function (e) {
      var t = Ye.f,
        ...
        a = (e.exports = {
          ...
          onFreeze: function (e) {
            return Ji && n && Bi(e) && !pe(e, r) && i(e), e;
          },
        });
      tt[r] = !0;
    });
  Mi.enable, Mi.fastKey, Mi.getWeakData, Mi.onFreeze;
  var Hi = p.TypeError,
    qi = function (e, t) {
    ...
    $i = function (e, t, n) {
      var r,
        ...
        p = pr(t, l),
        y = function (e) {
          return r && Do(r, 'normal', e), new qi(!0, e);
        },
        v = function (e) {
          return f
            ? (We(e), h ? p(e[0], e[1], y) : p(e[0], e[1]))
            : h
            ? p(e, y)
            : p(e);
        };
      ...
      for (s = r.next; !(u = b(s, r)).done; ) {
        ...
        if ('object' == typeof c && c && N(Qi, c)) return c;
      }
      return new qi(!1);
    },
    ea = p.TypeError,
          ...
          na(i, {
            ...
            forEach: function (e) {
              for (
                var t,
                  n = a(this),
                  r = pr(e, arguments.length > 1 ? arguments[1] : void 0);
                (t = t ? t.next : n.first);
  ...
  !(function (e, t, n) {
    ...
    if (
      ...
      (s = n.getConstructor(t, e, r, i)), Mi.enable();
    else if (Nt(e, !0)) {
      var f = new s(),
        d = f[i](o ? {} : -0, 1) != f,
        h = y(function () {
    ...
    cr.Set;
  var fa = setTimeout,
    da = 'undefined' != typeof setImmediate ? setImmediate : null;
  function ha(e) {
        ...
        ya._immediateFn(function () {
          ...
          if (null !== n) {
            ...
            try {
              ...
              return void ga(t.promise, e);
            }
            ma(t.promise, r);
          } else (1 === e._state ? ma : ga)(t.promise, e._value);
        }))
      : e._deferreds.push(t);
  }
  function ma(e, t) {
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        var n = t.then;
        if (t instanceof ya) return (e._state = 3), (e._value = t), void ba(e);
  ...
  function ga(e, t) {
    (e._state = 2), (e._value = t), ba(e);
  }
  function ba(e) {
    2 === e._state &&
      0 === e._deferreds.length &&
      ya._immediateFn(function () {
        e._handled || ya._unhandledRejectionFn(e._value);
      });
    for (var t = 0, n = e._deferreds.length; t < n; t++) va(e, e._deferreds[t]);
    e._deferreds = null;
  }
  function wa(e, t, n) {
  ...
  (ya.prototype.catch = function (e) {
    return this.then(null, e);
  }),
    (ya.prototype.then = function (e, t) {
      var n = new this.constructor(pa);
      return va(this, new wa(e, t, n)), n;
    }),
    (ya.prototype.finally = ua),
    (ya.all = function (e) {
      return new ya(function (t, n) {
        if (!ha(e)) return n(new TypeError('Promise.all accepts an array'));
        var r = Array.prototype.slice.call(e);
        if (0 === r.length) return t([]);
        var o = r.length;
        function i(e, a) {
    ...
    (ya.allSettled = la),
    (ya.resolve = function (e) {
      return e && 'object' == typeof e && e.constructor === ya
        ? e
        : new ya(function (t) {
            t(e);
          });
    }),
    (ya.reject = function (e) {
      return new ya(function (t, n) {
        n(e);
      });
    }),
    (ya.race = function (e) {
      return new ya(function (t, n) {
        if (!ha(e)) return n(new TypeError('Promise.race accepts an array'));
        for (var r = 0, o = e.length; r < o; r++) ya.resolve(e[r]).then(t, n);
      });
    }),
    (ya._immediateFn =
      ('function' == typeof da &&
    ...
    (ya._unhandledRejectionFn = function (e) {
  ...
  'function' != typeof ka.Promise
    ? (ka.Promise = ya)
    : (ka.Promise.prototype.finally || (ka.Promise.prototype.finally = ua),
      ka.Promise.allSettled || (ka.Promise.allSettled = la)),
    (function (e) {
      function t() {}
      function n(e, t) {
        if (
  ...
  var Ia = l(function (e, t) {
    ...
    Ca = { name: 'authok-spa-js', version: '1.19.4' },
    Aa = function () {
      return Date.now();
    },
    Ra = (function (e) {
        ...
        (r = function (a) {
          if (a.data && 'authorization_response' === a.data.type) {
            if (
              ...
              return n(Ra.fromPayload(a.data.response));
            t(a.data.response);
          }
        }),
    ...
    Ga = function () {
      var e =
        ...
        t = '';
      return (
        Array.from(La().getRandomValues(new Uint8Array(43))).forEach(function (
          n
        ) {
    ...
    Ma = function (e, t, n, r, a, c, s) {
      return (
        ...
        o(void 0, void 0, void 0, function () {
          return i(this, function (o) {
            return a ? [2, Ja(e, t, n, r, s, a, c)] : [2, Ba(e, r, s)];
          });
        })
      );
    };
  function Ha(e, t, n, a, c, s, u) {
      ...
      return i(this, function (i) {
        switch (i.label) {
          ...
          case 1:
            ...
            i.label = 2;
          case 2:
            return i.trys.push([2, 4, , 5]), [4, Ma(e, n, a, c, s, u, t)];
          case 3:
          ...
          case 6:
            ...
            if (
              ...
              if (
                ...
                throw new Fa(p, m, v.mfa_token);
              throw new Ra(p || 'request_error', m);
            }
            return [2, v];
        }
      });
                  ...
                  s,
                  {
                    ...
                    headers: {
                      'Content-Type': l
                        ...
                        : 'application/json',
                      'Authok-Client': btoa(JSON.stringify(u || Ca)),
                    },
                  },
                  t,
                  l
  ...
  var Qa = function (e) {
    ...
    $a = function () {
      ...
      return Qa(e.join(' ').trim().split(/\s+/)).join(' ');
    },
    ec = '@@authokspajs@@',
    tc = (function () {
      function e(e, t) {
    ...
    oc = (function () {
      function e(e, t, n) {
        (this.cache = e),
          (this.keyManifest = t),
          (this.nowProvider = n),
          (this.nowProvider = this.nowProvider || Aa);
      }
      return (
    ...
    sc = function (e) {
      ...
      var t = (function (e) {
        ...
        var c = JSON.parse(Ya(o)),
          s = { __raw: e },
          u = {};
        return (
          Object.keys(c).forEach(function (e) {
            (s[e] = c[e]), cc.includes(e) || (u[e] = c[e]);
          }),
          {
            encoded: { header: r, payload: o, signature: i },
            header: JSON.parse(Ya(r)),
            claims: s,
            user: u,
          }
        );
      ...
      if (e.max_age && !ac(t.claims.auth_time))
        throw new Error(
  ...
  u(uc), uc.encode, uc.parse, uc.getAll;
  var lc = uc.get,
    fc = uc.set,
    dc = uc.remove,
    hc = {
    ...
    yc = {
      get: function (e) {
        var t = hc.get(e);
        return t || hc.get(''.concat(pc).concat(e));
      },
      save: function (e, t, n) {
        var r = {};
        'https:' === window.location.protocol && (r = { secure: !0 }),
          (null == n ? void 0 : n.daysUntilExpire) &&
            (r.expires = n.daysUntilExpire),
          fc(''.concat(pc).concat(e), JSON.stringify(t), r),
          hc.save(e, t, n);
      },
      remove: function (e) {
        hc.remove(e), hc.remove(''.concat(pc).concat(e));
      },
    },
    vc = {
      get: function (e) {
  ...
  var gc,
    ...
    kc =
      ...
      (wc = !1),
      function (e) {
        return (Sc = Sc || mc(gc, bc, wc)), new Worker(Sc, e);
      }),
    _c = {},
    Ic = (function () {
      function e(e, t) {
      ...
      return (
        ...
        (e.prototype.createManifestKeyFrom = function (e) {
          return ''.concat(ec, '::').concat(e);
        }),
        e
      );
    })(),
    Tc = new Ta(),
    Oc = 'authok.lock.getTokenSilently',
    Ec = 'authok.is.authenticated',
    xc = {
      memory: function () {
        return new rc().enclosedCache;
      },
        ...
        if (
          ...
          'undefined' != typeof window &&
            (function () {
              if (!La())
                throw new Error(
                  'For security reasons, `window.crypto` is required to run `authok-spa-js`.'
                );
              if (void 0 === Za())
                throw new Error(
                  '\n      authok-spa-js must run on a secure origin. See https://github.com/authok/authok-spa-js/blob/master/FAQ.md#why-do-i-get-authok-spa-js-must-run-on-a-secure-origin for more information.\n    '
                );
            })(),
          e.cache &&
            e.cacheLocation &&
            console.warn(
              'Both `cache` and `cacheLocation` options have been specified in the AuthokClient configuration; ignoring `cacheLocation` and using `cache`.'
            ),
          e.cache)
        )
          o = e.cache;
          ...
          if (
            ((this.cacheLocation = e.cacheLocation || Ea),
            !Cc(this.cacheLocation))
          )
            throw new Error(
              'Invalid cache location "'.concat(this.cacheLocation, '"')
            );
          o = Cc(this.cacheLocation)();
        }
        (this.cookieStorage = !1 === e.legacySameSiteCookie ? hc : yc),
          (this.orgHintCookieName =
            ((i = this.options.client_id),
            'authok.'.concat(i, '.organization_hint'))),
          (this.isAuthenticatedCookieName = (function (e) {
            return 'authok.'.concat(e, '.is.authenticated');
          })(this.options.client_id)),
          (this.sessionCheckExpiryDays = e.sessionCheckExpiryDays || 1);
        var a,
          c = e.useCookiesForTransactions ? this.cookieStorage : vc;
        (this.scope = this.options.scope),
          (this.transactionManager = new ic(c, this.options.client_id)),
          (this.nowProvider = this.options.nowProvider || Aa),
          (this.cacheManager = new oc(
            o,
            o.allKeys ? null : new Ic(o, this.options.client_id),
            this.nowProvider
          )),
          (this.domainUrl =
          ...
          this.options.useRefreshTokens &&
            (this.scope = $a(this.scope, 'offline_access')),
          'undefined' != typeof window &&
            window.Worker &&
            this.options.useRefreshTokens &&
            this.cacheLocation === Ea &&
            Ac() &&
            (this.worker = new kc()),
      ...
      return (
        (e.prototype._url = function (e) {
          var t = encodeURIComponent(
            btoa(JSON.stringify(this.options.authokClient || Ca))
          );
          return ''
            .concat(this.domainUrl)
            .concat(e, '&authokClient=')
            .concat(t);
        }),
        (e.prototype._getParams = function (e, t, o, i, a) {
          ...
          return n(n(n({}, s), e), {
            scope: $a(this.defaultScope, this.scope, e.scope),
            response_type: 'code',
            response_mode: 'query',
            state: t,
            nonce: o,
        ...
        (e.prototype._authorizeUrl = function (e) {
          return this._url('/authorize?'.concat(Va(e)));
        }),
                    ...
                    qa(
                      {
                        ...
                        authokClient: this.options.authokClient,
                ...
                switch (o.label) {
                  case 0:
                    return (
                      ...
                      (n = $a(this.defaultScope, this.scope, e.scope)),
                      [
                        4,
                ...
                switch (i.label) {
                  case 0:
                    ...
                    if ((this.transactionManager.remove(), s))
                      throw new ja(s, u, o, l.appState);
                    if (!l.code_verifier || (l.state && l.state !== o))
                      throw (
                        (console.error(
                          'state: '
                            .concat(o, ', transaction.state: ')
                            .concat(l.state)
                        ),
                        new Error('Invalid state, state not match'))
                      );
                    return (
                      (f = {
                        audience: l.audience,
              ...
              switch (n.label) {
                case 0:
                  if (!this.cookieStorage.get(this.isAuthenticatedCookieName)) {
                    if (!this.cookieStorage.get(Ec)) return [2];
                    this.cookieStorage.save(
                      this.isAuthenticatedCookieName,
                      !0,
                      { daysUntilExpire: this.sessionCheckExpiryDays }
                    ),
                      this.cookieStorage.remove(Ec);
                  }
                  n.label = 1;
                case 1:
                  return (
                ...
                case 2:
                  return n.sent(), [3, 4];
                case 3:
                  if (((t = n.sent()), !xa.includes(t.error))) throw t;
                  return [3, 4];
                case 4:
                  return [2];
              }
                ...
                switch (r.label) {
                  case 0:
                    return (
                      ...
                      (e.scope = $a(this.defaultScope, this.scope, e.scope)),
                      (t = n(n({}, Oa), t)),
        ...
        (e.prototype.buildLogoutUrl = function (e) {
          ...
          var t = e.federated,
            n = r(e, ['federated']),
            o = t ? '&federated' : '';
          return this._url('/v1/logout?'.concat(Va(n))) + o;
        }),
        ...
        (e.prototype._getTokenFromIFrame = function (e) {
          return o(this, void 0, void 0, function () {
            ...
            return i(this, function (i) {
              switch (i.label) {
                case 0:
                  return (t = Xa(Ga())), (o = Xa(Ga())), (a = Ga()), [4, Na(a)];
                case 1:
                  (c = i.sent()),
                    (s = Da(c)),
                        ...
                        if (
                          ...
                          a && a.close(),
                            n.data.response.error
                              ? t(Ra.fromPayload(n.data.response))
                              : e(n.data.response),
                            clearTimeout(i),
                            window.removeEventListener('message', r, !1),
                            setTimeout(o, 2e3);
              ...
              switch (i.label) {
                case 0:
                  return [
                    4,
                    this.cacheManager.get(
                      new tc({ scope: t, audience: r, client_id: a }),
                      60
                    ),
                  ];
                case 1:
  ...
  function jc(e) {
    return o(this, void 0, void 0, function () {
      ...
      return i(this, function (n) {
        switch (n.label) {
          case 0:
            return [4, (t = new Rc(e)).checkSession()];
          case 1:
            return n.sent(), [2, t];
        }
      });
  ...
  return (
    (Uc.AuthokClient = Rc),
    (Uc.createAuthokClient = jc),
    (Uc.GenericError = Ra),
    (Uc.AuthenticationError = ja),
    (Uc.TimeoutError = Ua),
    (Uc.PopupTimeoutError = Pa),
    (Uc.MfaRequiredError = Fa),
    Uc
  );
}),
  'AuthokClient' in this &&
    this.console &&
    this.console.warn &&
    this.console.warn('AuthokClient already declared on the global namespace'),
  this &&
    this.createAuthokClient &&
    (this.AuthokClient =
      this.AuthokClient || this.createAuthokClient.AuthokClient);
//# sourceMappingURL=authok-spa-js.production.js.map
