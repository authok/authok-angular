(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global =
      ...
      (global.createAuthokClient = factory()));
})(this, function () {
  'use strict';
  ...
  var classof = toStringTagSupport
    ...
    : function (it) {
        ...
        return it === undefined
          ...
          ? 'Null'
          : // @@toStringTag case
          typeof (tag = tryGet((O = Object$2(it)), TO_STRING_TAG$2)) == 'string'
          ? tag
          : // builtinTag case
          CORRECT_ARGUMENTS
          ? classofRaw(O)
  ...
  var $defineProperties = function defineProperties(O, Properties) {
    ...
    $forEach(keys, function (key) {
      if (!descriptors || functionCall($propertyIsEnumerable, properties, key))
  ...
  var $getOwnPropertySymbols = function getOwnPropertySymbols(O) {
    ...
    $forEach(names, function (key) {
      if (
        hasOwnProperty_1(AllSymbols, key) &&
        (!IS_OBJECT_PROTOTYPE || hasOwnProperty_1(ObjectPrototype$2, key))
      ) {
  ...
  /**
   * Thrown when handling the redirect callback fails, will be one of Authok's
   * Authentication API's Standard Error Responses: https://authok.cn/docs/api/authentication?javascript#standard-error-responses
   */
  ...
  var runIframe = function (authorizeUrl, eventOrigin, timeoutInSeconds) {
    ...
    return new Promise(function (res, rej) {
      ...
      iframeEventHandler = function (e) {
        ...
        // in Chrome: https://github.com/authok/authok-spa-js/issues/240
  ...
  var openPopup = function (url) {
    ...
    return window.open(
      ...
      'left='
        ...
        .concat(top, ',width=')
        .concat(width, ',height=')
        .concat(height, ',resizable,scrollbars=yes,status=1')
    );
  };
    ...
    return urlEncodeB64(
      window.btoa(
        String.fromCharCode.apply(
          String,
          __spreadArray([], __read(Array.from(ie11SafeInput)), false)
        )
      )
    );
  };
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 6:
            ...
            if (!ok) {
              errorMessage =
                error_description || 'HTTP error. Unable to fetch '.concat(url);
  ...
  var CACHE_KEY_PREFIX = '@@authokspajs@@';
  ...
  var CacheManager = /** @class */ (function () {
     ...
     *  - `prefix` is strict equal to Authok's internally configured `keyPrefix`
  ...
  var TransactionManager = /** @class */ (function () {
    function TransactionManager(storage, clientId) {
      ...
      this.storageKey = ''
        .concat(TRANSACTION_STORAGE_KEY_PREFIX, '.')
  ...
  var verify = function (options) {
    ...
    if (decoded.claims.iss !== options.iss) {
      throw new Error(
        'Issuer (iss) claim mismatch in the ID token; expected "'
          .concat(options.iss, '", found "')
          .concat(decoded.claims.iss, '"')
      );
    }
    if (!decoded.user.sub) {
      throw new Error(
    ...
    if (Array.isArray(decoded.claims.aud)) {
      if (!decoded.claims.aud.includes(options.aud)) {
        throw new Error(
          'Audience (aud) claim mismatch in the ID token; expected "'
            .concat(options.aud, '" but was not one of "')
            .concat(decoded.claims.aud.join(', '), '"')
        );
      }
        ...
        if (decoded.claims.azp !== options.aud) {
          throw new Error(
            'Authorized Party (azp) claim mismatch in the ID token; expected "'
              .concat(options.aud, '", found "')
              .concat(decoded.claims.azp, '"')
          );
        }
      }
      ...
      throw new Error(
        'Audience (aud) claim mismatch in the ID token; expected "'
          .concat(options.aud, '" but found "')
          .concat(decoded.claims.aud, '"')
      );
    }
    if (options.nonce) {
      ...
      if (decoded.claims.nonce !== options.nonce) {
        throw new Error(
          'Nonce (nonce) claim mismatch in the ID token; expected "'
            .concat(options.nonce, '", found "')
            .concat(decoded.claims.nonce, '"')
        );
      }
    }
    ...
    if (now > expDate) {
      throw new Error(
        'Expiration Time (exp) claim error in the ID token; current time ('
          .concat(now, ') is after expiration time (')
          .concat(expDate, ')')
      );
    }
    ...
    if (isNumber(decoded.claims.auth_time) && now > authTimeDate) {
      throw new Error(
        'Authentication Time (auth_time) claim in the ID token indicates that too much time has passed since the last end-user authentication. Currrent time ('
          .concat(now, ') is after last auth at ')
          .concat(authTimeDate)
      );
    }
      ...
      if (!decoded.claims.org_id) {
        ...
        throw new Error(
          'Organization ID (org_id) claim mismatch in the ID token; expected "'
            .concat(options.organizationId, '", found "')
            .concat(decoded.claims.org_id, '"')
        );
      }
    }
    return decoded;
  ...
  var CookieStorageWithLegacySameSite = {
    ...
    save: function (key, value, options) {
      ...
      esCookie_5(
        ''.concat(LEGACY_PREFIX).concat(key),
   ...
   * @ignore
   */
  var GET_TOKEN_SILENTLY_LOCK_KEY = 'authok.lock.getTokenSilently';
  /**
   * @ignore
   */
  var buildOrganizationHintCookieName = function (clientId) {
    return 'authok.'.concat(clientId, '.organization_hint');
  };
  /**
   * @ignore
   */
  var OLD_IS_AUTHENTICATED_COOKIE_NAME = 'authok.is.authenticated';
  /**
   * @ignore
   */
  var buildIsAuthenticatedCookieName = function (clientId) {
    return 'authok.'.concat(clientId, '.is.authenticated');
  };
  /**
   * @ignore
   */
   ...
   */
  var AuthokClient = /** @class */ (function () {
    function AuthokClient(options) {
      var _a, _b;
    ...
    AuthokClient.prototype._url = function (path) {
      var authokClient = encodeURIComponent(
        btoa(JSON.stringify(this.options.authokClient || DEFAULT_AUTHOK_CLIENT))
      );
      return ''
        .concat(this.domainUrl)
        .concat(path, '&authokClient=')
        .concat(authokClient);
    };
    AuthokClient.prototype._getParams = function (
      authorizeOptions,
      state,
      nonce,
      code_challenge,
    ...
    AuthokClient.prototype._authorizeUrl = function (authorizeOptions) {
      return this._url(
        '/authorize?'.concat(createQueryParams(authorizeOptions))
      );
    };
    AuthokClient.prototype._verifyIdToken = function (
      id_token,
      nonce,
      organizationId
    ) {
    ...
    AuthokClient.prototype._parseNumber = function (value) {
      if (typeof value !== 'string') {
        return value;
      }
      return parseInt(value, 10) || undefined;
    };
    AuthokClient.prototype._processOrgIdHint = function (organizationId) {
      if (organizationId) {
    ...
    /**
     * ```js
     * await authok.buildAuthorizeUrl(options);
     * ```
     *
     ...
     * @param options
     */
    AuthokClient.prototype.buildAuthorizeUrl = function (options) {
      if (options === void 0) {
        options = {};
      }
      return __awaiter(this, void 0, void 0, function () {
     ...
     * ```js
     * try {
     *  await authok.loginWithPopup(options);
     * } catch(e) {
     ...
     * @param config
     */
    AuthokClient.prototype.loginWithPopup = function (options, config) {
      return __awaiter(this, void 0, void 0, function () {
     ...
     * @param options
     */
    AuthokClient.prototype.getUser = function (options) {
      if (options === void 0) {
        options = {};
      }
      return __awaiter(this, void 0, void 0, function () {
    ...
    /**
     * ```js
     * const claims = await authok.getIdTokenClaims();
     * ```
     *
     ...
     * @param options
     */
    AuthokClient.prototype.getIdTokenClaims = function (options) {
      if (options === void 0) {
        options = {};
      }
      return __awaiter(this, void 0, void 0, function () {
    ...
    /**
     * ```js
     * await authok.loginWithRedirect(options);
     * ```
     *
     ...
     * @param options
     */
    AuthokClient.prototype.loginWithRedirect = function (options) {
      if (options === void 0) {
        options = {};
      }
      return __awaiter(this, void 0, void 0, function () {
     ...
     */
    AuthokClient.prototype.handleRedirectCallback = function (url) {
      if (url === void 0) {
          ...
          switch (_b.label) {
            case 0:
              ...
              if (
                ...
                console.error(
                  'state: '
                    .concat(state, ', transaction.state: ')
                    .concat(transaction.state)
                );
     ...
     *
     * This method also heeds the `authok.{clientId}.is.authenticated` cookie, as an optimization
     *  to prevent calling Authok unnecessarily. If the cookie is not present because
     * there was no previous login (or it has expired) then tokens will not be refreshed.
     *
     * It should be used for silently logging in the user when you instantiate the
     * `AuthokClient` constructor. You should not need this if you are using the
     * `createAuthokClient` factory.
     *
     ...
     * and handle the possible `login_required` error [as shown in the readme](https://github.com/authok/authok-spa-js#creating-the-client).
     *
     * @param options
     */
    AuthokClient.prototype.checkSession = function (options) {
      return __awaiter(this, void 0, void 0, function () {
        var error_1;
        return __generator(this, function (_a) {
          switch (_a.label) {
     ...
     *
     * ```js
     * const token = await authok.getTokenSilently(options);
     * ```
     *
     ...
     * @param options
     */
    AuthokClient.prototype.getTokenSilently = function (options) {
      if (options === void 0) {
        options = {};
      }
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          ...
          return [
            ...
            singlePromise(function () {
              ...
              .concat(getTokenOptions.audience, '::')
              .concat(getTokenOptions.scope)),
          ];
        });
      });
    };
    AuthokClient.prototype._getTokenSilently = function (options) {
      if (options === void 0) {
        options = {};
      }
      return __awaiter(this, void 0, void 0, function () {
            ...
            case 11:
              ...
              if (options.detailedResponse) {
                (id_token = authResult.id_token),
                  ...
                  (oauthTokenScope = authResult.oauthTokenScope),
    ...
    /**
     * ```js
     * const token = await authok.getTokenWithPopup(options);
     * ```
     * Opens a popup with the `/authorize` URL using the parameters
     * provided as arguments. Random and secure `state` and `nonce`
     * parameters will be auto-generated. If the response is successful,
     ...
     * @param config
     */
    AuthokClient.prototype.getTokenWithPopup = function (options, config) {
      if (options === void 0) {
        options = {};
      }
      if (config === void 0) {
     ...
     *
     */
    AuthokClient.prototype.isAuthenticated = function () {
      return __awaiter(this, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
          switch (_a.label) {
    ...
    /**
     * ```js
     * await authok.buildLogoutUrl(options);
     * ```
     *
     * Builds a URL to the logout endpoint using the parameters provided as arguments.
     * @param options
     */
    AuthokClient.prototype.buildLogoutUrl = function (options) {
      if (options === void 0) {
        options = {};
      }
      ...
      var url = this._url(
        '/v1/logout?'.concat(createQueryParams(logoutOptions))
      );
     ...
     * @param options
     */
    AuthokClient.prototype.logout = function (options) {
      var _this = this;
      if (options === void 0) {
        options = {};
      }
    ...
    AuthokClient.prototype._getTokenFromIFrame = function (options) {
      return __awaiter(this, void 0, void 0, function () {
        var stateIn,
          nonceIn,
          code_verifier,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 4:
              ...
              return [
                4 /*yield*/,
                this._verifyIdToken(tokenResult.id_token, nonceIn),
              ];
            case 5:
              decodedToken = _a.sent();
              this._processOrgIdHint(decodedToken.claims.org_id);
    ...
    AuthokClient.prototype._getTokenUsingRefreshToken = function (options) {
      return __awaiter(this, void 0, void 0, function () {
        var cache,
          redirect_uri,
          tokenResult,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 8:
              throw e_2;
            case 9:
              return [4 /*yield*/, this._verifyIdToken(tokenResult.id_token)];
            case 10:
              decodedToken = _a.sent();
              return [
                2 /*return*/,
    ...
    AuthokClient.prototype._getEntryFromCache = function (_a) {
      var scope = _a.scope,
        audience = _a.audience,
        client_id = _a.client_id,
        _b = _a.getDetailedEntry,
        getDetailedEntry = _b === void 0 ? false : _b;
      return __awaiter(this, void 0, void 0, function () {
              ...
              if (entry && entry.access_token) {
                if (getDetailedEntry) {
                  (id_token = entry.id_token),
                    ...
                    (oauthTokenScope = entry.oauthTokenScope),
   ...
   */
  function createAuthokClient(options) {
    return __awaiter(this, void 0, void 0, function () {
      var authok;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            authok = new AuthokClient(options);
            return [4 /*yield*/, authok.checkSession()];
          case 1:
            _a.sent();
   ...
   * @ignore
   */
  var wrapper = createAuthokClient;
...
//# sourceMappingURL=authok-spa-js.development.js.map
