...
export interface BaseLoginOptions {
  ...
  /**
   * Provides a hint to Authok as to what flow should be displayed.
...
export interface AuthokClientOptions extends BaseLoginOptions {
  /**
  ...
  /**
   * Number of days until the cookie `authok.is.authenticated` will expire
   * Defaults to 1.
   */
   ...
   *
   * **Note:** Setting this to `true` may affect you if you use Authok Rules and are sending custom, non-primative data. If you enable this, please verify that your Authok Rules
...
export interface RedirectLoginOptions<TAppState = any>
  ...
  /**
   * The URL where Authok will redirect your browser to with
   * the authentication result. It must be whitelisted in
   * the "Allowed Callback URLs" field in your Authok Application's
   * settings.
   */
...
export interface LogoutUrlOptions {
  /**
   * The URL where Authok will redirect your browser to after the logout.
   *
   * **Note**: If the `client_id` parameter is included, the
   * `return_to` URL that is provided must be listed in the
   * Application's "Allowed Logout URLs" in the Authok dashboard.
   * However, if the `client_id` parameter is not included, the
   * `return_to` URL must be listed in the "Allowed Logout URLs" at
   * the account level in the Authok dashboard.
   *
   * [Read more about how redirecting after logout works](https://authok.cn/docs/logout/guides/redirect-users-after-logout)
   */
  return_to?: string;
  /**
   ...
   * and from Authok.
   * [Read more about how federated logout works at Authok](https://authok.cn/docs/logout/guides/logout-idps)
   */
  federated?: boolean;
}
...
export declare type GetTokenSilentlyVerboseResponse = Omit<
