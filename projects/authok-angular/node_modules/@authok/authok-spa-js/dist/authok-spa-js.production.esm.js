...
var M = d,
  ...
  Ae = {
    f: v
      ...
      : function (e, t) {
          ...
          if (he(e, t)) return I(!b(_.f, e, t), e[t]);
        },
  },
  Ue =
    v &&
  ...
  Fe = function (e) {
    if (G(e)) return e;
    throw Pe(Ke(e) + ' is not an object');
  },
  We = p.TypeError,
...
var Ne,
  ...
  ze = se.inspectSource,
  Be = p.WeakMap,
  Je = Z(Be) && /native code/.test(ze(Be)),
  Me = ue('keys'),
  He = function (e) {
    return Me[e] || (Me[e] = me(e));
  },
  qe = {},
  Qe = p.TypeError,
  $e = p.WeakMap;
...
var it = {
    ...
    has: De,
    enforce: function (e) {
      return De(e) ? Ye(e) : Ne(e, {});
    },
    getterFor: function (e) {
      return function (t) {
        var n;
        if (!G(t) || (n = Ye(t)).type !== e)
  ...
  lt = l(function (e) {
    ...
    (e.exports = function (e, n, i, a) {
      ...
      return (Z(this) && n(this).source) || ze(this);
    });
  }),
  ft = Math.ceil,
  dt = Math.floor,
  ...
  It = function (e, t) {
    var n,
      ...
      o = 0,
      i = [];
    for (n in r) !he(qe, n) && he(r, n) && _t(i, n);
    for (; t.length > o; ) he(r, (n = t[o++])) && (~kt(i, n) || _t(i, n));
    return i;
  },
  Tt = [
    'constructor',
  ...
  Ut = function (e, t) {
    var n = Pt[Kt(e)];
    return n == Wt || (n != Ft && (Z(t) ? y(t) : !!t));
  },
  Kt = (Ut.normalize = function (e) {
...
Nt || lt(Object.prototype, 'toString', Rn, { unsafe: !0 });
var jn,
  ...
  Wn =
    v && !Ue
      ...
      : function (e, t) {
          Fe(e);
          for (var n, r = L(t), o = Fn(t), i = o.length, a = 0; i > a; )
            Ge.f(e, (n = o[a++]), r[n]);
          return e;
        },
  Ln = { f: Wn },
...
var Dn =
  ...
  qn = {
    f: function (e) {
      return Mn && 'Window' == A(e) ? Hn(e) : Jn(L(e));
    },
  },
  Qn = C([].slice),
  $n = { f: ke },
  ...
  tr = Ge.f,
  nr = function (e) {
    var t = er.Symbol || (er.Symbol = {});
    he(t, e) || tr(t, e, { value: $n.f(e) });
  },
  rr = Ge.f,
  or = ke('toStringTag'),
  ir = function (e, t, n) {
    e && !n && (e = e.prototype),
      e && !he(e, or) && rr(e, or, { configurable: !0, value: t });
  },
  ar = C(C.bind),
  cr = function (e, t) {
    return (
  ...
  Or = ue('symbols'),
  Er = ue('op-symbols'),
  xr = ue('string-to-symbol-registry'),
  Cr = ue('symbol-to-string-registry'),
  Rr = ue('wks'),
  jr = !br || !br.prototype || !br.prototype.findChild,
  Ar =
    v &&
    y(function () {
      return (
      ...
      ? function (e, t, n) {
          var r = Sr(yr, t);
          r && delete yr[t], kr(e, t, n), r && e !== yr && kr(yr, t, r);
        }
      : kr,
  Ur = function (e, t) {
    var n = (Or[e] = Dn(mr));
    return (
      hr(n, { type: 'Symbol', tag: e, description: t }),
      v || (n.description = t),
      n
    );
  },
  Kr = function (e, t, n) {
    ...
    return (
      ...
      he(Or, r)
        ? (n.enumerable
            ? (he(e, fr) && e[fr][r] && (e[fr][r] = !1),
              (n = Dn(n, { enumerable: I(0, !1) })))
            : (he(e, fr) || kr(e, fr, I(1, {})), (e[fr][r] = !0)),
          Ar(e, r, n))
        : kr(e, r, n)
    );
  },
  ...
  Fr = function (e) {
    var t = Oe(e),
      n = b(Ir, this, t);
    return (
      !(this === yr && he(Or, t) && !he(Er, t)) &&
      (!(n || !he(this, t) || !he(Or, t) || (he(this, fr) && this[fr][t])) || n)
    );
  },
  Wr = function (e, t) {
    var n = L(e),
      r = Oe(t);
    if (n !== yr || !he(Or, r) || he(Er, r)) {
      var o = Sr(n, r);
      return (
        !o || !he(Or, r) || (he(n, fr) && n[fr][r]) || (o.enumerable = !0), o
      );
    }
  },
  Lr = function (e) {
...
if (
  (H ||
    ((mr = (vr = function () {
      if (N(mr, this)) throw gr('Symbol is not a constructor');
      var e =
        ...
        n = function (e) {
          this === yr && b(n, Er, e),
            he(this, fr) && he(this[fr], t) && (this[fr][t] = !1),
            Ar(this, t, I(1, e));
        };
      return v && jr && Ar(yr, t, { configurable: !0, set: n }), Ur(t, e);
    }).prototype),
    lt(mr, 'toString', function () {
      return pr(this).tag;
    }),
    lt(vr, 'withoutSetter', function (e) {
      return Ur(me(e), e);
    }),
    (_.f = Fr),
    (Ge.f = Kr),
    ...
    v &&
      ...
      lt(yr, 'propertyIsEnumerable', Fr, { unsafe: !0 }))),
  Gt({ global: !0, wrap: !0, forced: !H, sham: !H }, { Symbol: vr }),
  lr(Fn(Rr), function (e) {
    nr(e);
  }),
  Gt(
    { target: 'Symbol', stat: !0, forced: !H },
    {
      for: function (e) {
        var t = Mt(e);
        if (he(xr, t)) return xr[t];
        var n = vr(t);
        return (xr[t] = n), (Cr[n] = t), n;
      },
      keyFor: function (e) {
        if (!$(e)) throw gr(e + ' is not a symbol');
        if (he(Cr, e)) return Cr[e];
      },
      useSetter: function () {
        jr = !0;
      },
  ...
  Gt(
    ...
    {
      create: function (e, t) {
        return void 0 === t ? Dn(e) : Pr(Dn(e), t);
      },
      defineProperty: Kr,
      defineProperties: Pr,
  ...
  Gt(
    ...
    { getOwnPropertyNames: Lr, getOwnPropertySymbols: Zr }
  ),
  Gt(
    {
      target: 'Object',
...
ir(vr, 'Symbol'), (qe[fr] = !0), nr('asyncIterator');
var Vr = Ge.f,
  Nr = p.Symbol,
  Yr = Nr && Nr.prototype;
if (v && Z(Nr) && (!('description' in Yr) || void 0 !== Nr().description)) {
  var Dr = {},
    zr = function () {
      var e =
          arguments.length < 1 || void 0 === arguments[0]
            ? void 0
            : Mt(arguments[0]),
        t = N(Yr, this) ? new Nr(e) : void 0 === e ? Nr() : Nr(e);
      return '' === e && (Dr[t] = !0), t;
    };
  jt(zr, Nr), (zr.prototype = Yr), (Yr.constructor = zr);
  var Br = 'Symbol(test)' == String(Nr('test')),
    Jr = C(Yr.toString),
    Mr = C(Yr.valueOf),
    Hr = /^Symbol\((.*)\)[^)]+$/,
    qr = C(''.replace),
  ...
  Vr(Yr, 'description', {
    ...
    get: function () {
      var e = Mr(this),
        t = Jr(e);
      if (he(Dr, e)) return '';
      var n = Br ? Qr(t, 7, -1) : qr(t, Hr, '$1');
      return '' === n ? void 0 : n;
    },
  }),
    Gt({ global: !0, forced: !0 }, { Symbol: zr });
}
nr('hasInstance'),
...
[].keys &&
  ('next' in (to = [].keys())
    ? (eo = fo(fo(to))) !== Object.prototype && ($r = eo)
    : (po = !0));
var yo =
  null == $r ||
  y(function () {
    var e = {};
    return $r[ho].call(e) !== e;
  });
yo && ($r = {}),
  Z($r[ho]) ||
    lt($r, ho, function () {
...
var vo = { IteratorPrototype: $r, BUGGY_SAFARI_ITERATORS: po },
  mo = {},
  go = vo.IteratorPrototype,
  bo = function () {
    return this;
  },
  wo = p.String,
          ...
          return function (n, r) {
            return (
              ...
              (function (e) {
                ...
                throw So("Can't set " + wo(e) + ' as a prototype');
              })(r),
  ...
  _o = ut.PROPER,
  Io = ut.CONFIGURABLE,
  To = vo.IteratorPrototype,
  Oo = vo.BUGGY_SAFARI_ITERATORS,
  Eo = ke('iterator'),
  xo = function () {
    return this;
  },
  Co = function (e, t, n, r, o, i, a) {
    !(function (e, t, n, r) {
      var o = t + ' Iterator';
      (e.prototype = Dn(go, { next: I(+!r, n) })), ir(e, o, !1), (mo[o] = bo);
    })(n, t, r);
    var c,
      s,
      u,
      ...
      d = !1,
      h = e.prototype,
      p = h[Eo] || h['@@iterator'] || (o && h[o]),
      y = (!Oo && p) || l(o),
      v = ('Array' == t && h.entries) || p;
    if (
      (v &&
        (c = fo(v.call(new e()))) !== Object.prototype &&
        c.next &&
        (fo(c) !== To && (ko ? ko(c, To) : Z(c[Eo]) || lt(c, Eo, xo)),
        ir(c, f, !0)),
      _o &&
        'values' == o &&
        p &&
      ...
      if (
        ...
        for (u in s) (Oo || d || !(u in h)) && lt(h, u, s[u]);
      else Gt({ target: t, proto: !0, forced: Oo || d }, s);
    return h[Eo] !== y && lt(h, Eo, y, { name: o }), (mo[t] = y), s;
  },
  Ro = ao.charAt,
  jo = it.set,
  Ao = it.getterFor('String Iterator');
Co(
  String,
  'String',
  function (e) {
    jo(this, { type: 'String Iterator', string: Mt(e), index: 0 });
  },
  function () {
    var e,
      t = Ao(this),
    ...
    return r >= n.length
      ? { value: void 0, done: !0 }
      : ((e = Ro(n, r)), (t.index += e.length), { value: e, done: !1 });
  }
);
var Uo = function (e, t, n) {
  ...
  Fo = Array.prototype,
  Wo = function (e) {
    return void 0 !== e && (mo.Array === e || Fo[Po] === e);
  },
  Lo = ke('iterator'),
  Zo = function (e) {
    if (null != e) return oe(e, Lo) || oe(e, '@@iterator') || mo[Bt(e)];
  },
  Go = p.TypeError,
  Xo = function (e, t) {
    var n = arguments.length < 2 ? Zo(e) : t;
    if (re(n)) return Fe(b(n, e));
    throw Go(te(e) + ' is not iterable');
  },
  Vo = p.Array,
  No = ke('iterator'),
  Yo = !1;
  ...
  { target: 'Array', stat: !0, forced: Jo },
  {
    from: function (e) {
      ...
      var a,
        ...
        h = 0;
      if (!d || (this == Vo && Wo(d)))
        for (a = bt(t), c = n ? new this(a) : Vo(a); a > h; h++)
          (f = i ? o(t[h], h) : t[h]), ln(c, h, f);
      else
        for (
          l = (u = Xo(t, d)).next, c = n ? new this() : [];
          !(s = b(l, u)).done;
          h++
        )
          (f = i ? Ko(u, o, [s.value, h], !0) : s.value), ln(c, h, f);
      return (c.length = h), c;
    },
  }
),
...
var Mo,
  Ho,
  qo,
  Qo = 'undefined' != typeof ArrayBuffer && 'undefined' != typeof DataView,
  $o = Ge.f,
  ei = p.Int8Array,
  ti = ei && ei.prototype,
  ni = p.Uint8ClampedArray,
  ri = ni && ni.prototype,
  oi = ei && fo(ei),
  ii = ti && fo(ti),
  ai = Object.prototype,
  ci = p.TypeError,
  si = ke('toStringTag'),
  ui = me('TYPED_ARRAY_TAG'),
  li = me('TYPED_ARRAY_CONSTRUCTOR'),
  fi = Qo && !!ko && 'Opera' !== Bt(p.opera),
  di = !1,
  hi = {
    Int8Array: 1,
    Uint8Array: 1,
  ...
  pi = { BigInt64Array: 8, BigUint64Array: 8 },
  yi = function (e) {
    if (!G(e)) return !1;
    var t = Bt(e);
    return he(hi, t) || he(pi, t);
  };
for (Mo in hi) (qo = (Ho = p[Mo]) && Ho.prototype) ? Xe(qo, li, Ho) : (fi = !1);
for (Mo in pi) (qo = (Ho = p[Mo]) && Ho.prototype) && Xe(qo, li, Ho);
if (
  (!fi || !Z(oi) || oi === Function.prototype) &&
  ((oi = function () {
    throw ci('Incorrect invocation');
  }),
  fi)
)
  for (Mo in hi) p[Mo] && ko(p[Mo], oi);
if ((!fi || !ii || ii === ai) && ((ii = oi.prototype), fi))
  for (Mo in hi) p[Mo] && ko(p[Mo].prototype, ii);
if ((fi && fo(ri) !== ii && ko(ri, ii), v && !he(ii, si)))
  for (Mo in ((di = !0),
  $o(ii, si, {
    get: function () {
  ...
  hi))
    p[Mo] && Xe(p[Mo], ui, Mo);
var vi = {
    NATIVE_ARRAY_BUFFER_VIEWS: fi,
    TYPED_ARRAY_CONSTRUCTOR: li,
    TYPED_ARRAY_TAG: di && ui,
    aTypedArray: function (e) {
      if (yi(e)) return e;
      throw ci('Target is not a typed array');
    },
    aTypedArrayConstructor: function (e) {
      if (Z(e) && (!ko || N(oi, e))) return e;
      throw ci(te(e) + ' is not a typed array constructor');
    },
    exportTypedArrayMethod: function (e, t, n, r) {
      if (v) {
        ...
        (ii[e] && !n) || lt(ii, e, n ? t : (fi && ti[e]) || t, r);
      }
    },
    exportTypedArrayStaticMethod: function (e, t, n) {
      ...
      if (v) {
        if (ko) {
          ...
          if (oi[e] && !n) return;
          try {
            return lt(oi, e, n ? t : (fi && oi[e]) || t);
          } catch (e) {}
        }
        for (r in hi) !(o = p[r]) || (o[e] && !n) || lt(o, e, t);
      }
    },
    isView: function (e) {
      if (!G(e)) return !1;
      var t = Bt(e);
      return 'DataView' === t || he(hi, t) || he(pi, t);
    },
    isTypedArray: yi,
    TypedArray: oi,
    TypedArrayPrototype: ii,
  },
  mi = p.TypeError,
  gi = ke('species'),
  bi = function (e, t) {
    var n,
      r = Fe(e).constructor;
    return void 0 === r || null == (n = Fe(r)[gi])
      ? t
      : (function (e) {
          if (wn(e)) return e;
          throw mi(te(e) + ' is not a constructor');
        })(n);
  },
  wi = vi.TYPED_ARRAY_CONSTRUCTOR,
  Si = vi.aTypedArrayConstructor,
  ki = vi.aTypedArray;
...
var _i = ke('unscopables'),
  Ii = Array.prototype;
null == Ii[_i] && Ge.f(Ii, _i, { configurable: !0, value: Dn(null) });
var Ti = function (e) {
    Ii[_i][e] = !0;
  },
  Oi = St.includes;
...
var xi = Ge.f,
  Ci = it.set,
  Ri = it.getterFor('Array Iterator');
Co(
  Array,
  'Array',
  function (e, t) {
    Ci(this, { type: 'Array Iterator', target: L(e), index: 0, kind: t });
  },
  function () {
    var e = Ri(this),
      t = e.target,
...
if ((Ti('keys'), Ti('values'), Ti('entries'), v && 'values' !== ji.name))
  try {
...
var Ai = y(function () {
  ...
  Ki =
    y(function () {
      ...
      ? function (e) {
          return !!G(e) && (!Ai || 'ArrayBuffer' != A(e)) && (!Ui || Ui(e));
        }
      : Ui,
  Pi = !y(function () {
...
var Wi = p.TypeError,
  ...
  Gi = function (e, t, n) {
    var r,
      ...
      p = cr(t, l),
      y = function (e) {
        return r && Uo(r, 'normal', e), new Li(!0, e);
      },
      v = function (e) {
        return f
          ? (Fe(e), h ? p(e[0], e[1], y) : p(e[0], e[1]))
          : h
          ? p(e, y)
          : p(e);
      };
    if (d) r = e;
      ...
      if (!(o = Zo(e))) throw Wi(te(e) + ' is not iterable');
      if (Wo(o)) {
        for (i = 0, a = bt(e); a > i; i++)
          if ((c = v(e[i])) && N(Zi, c)) return c;
        return new Li(!1);
      }
      r = Xo(e, o);
    }
    for (s = r.next; !(u = b(s, r)).done; ) {
      ...
      if ('object' == typeof c && c && N(Zi, c)) return c;
    }
    return new Li(!1);
  },
  Xi = p.TypeError,
  ...
  Mi = {
    getConstructor: function (e, t, n, r) {
      var o = e(function (e, o) {
          Vi(e, i),
            ...
            v || (e.size = 0),
            null != o && Gi(o, e[r], { that: e, AS_ENTRIES: n });
        }),
        i = o.prototype,
        a = Ji(t),
        c = function (e, t, n) {
        ...
        Ni(i, {
          ...
          forEach: function (e) {
            for (
              var t,
                n = a(this),
                r = cr(e, arguments.length > 1 ? arguments[1] : void 0);
              (t = t ? t.next : n.first);
    ...
    setStrong: function (e, t, n) {
      ...
      Co(
        ...
        t,
        function (e, t) {
          Bi(this, { type: r, target: e, state: o(e), kind: t, last: void 0 });
        },
        function () {
...
!(function (e, t, n) {
  ...
  if (
    ...
    (s = n.getConstructor(t, e, r, i)), Fi.enable();
  else if (Lt(e, !0)) {
    var f = new s(),
      d = f[i](o ? {} : -0, 1) != f,
      h = y(function () {
    ...
    v ||
      (((s = t(function (e, t) {
        ...
        return null != t && Gi(t, n[i], { that: n, AS_ENTRIES: r }), n;
      })).prototype = c),
      (c.constructor = s)),
    ...
    ? ((e._handled = !0),
      na._immediateFn(function () {
        ...
        if (null !== n) {
          ...
          oa(t.promise, r);
        } else (1 === e._state ? oa : ia)(t.promise, e._value);
      }))
    : e._deferreds.push(t);
}
function oa(e, t) {
  try {
    ...
    if (t && ('object' == typeof t || 'function' == typeof t)) {
      var n = t.then;
      if (t instanceof na) return (e._state = 3), (e._value = t), void aa(e);
...
function ia(e, t) {
  (e._state = 2), (e._value = t), aa(e);
}
function aa(e) {
  2 === e._state &&
    0 === e._deferreds.length &&
    na._immediateFn(function () {
      e._handled || na._unhandledRejectionFn(e._value);
    });
  for (var t = 0, n = e._deferreds.length; t < n; t++) ra(e, e._deferreds[t]);
  e._deferreds = null;
}
function ca(e, t, n) {
...
(na.prototype.catch = function (e) {
  return this.then(null, e);
}),
  (na.prototype.then = function (e, t) {
    var n = new this.constructor(ta);
    return ra(this, new ca(e, t, n)), n;
  }),
  (na.prototype.finally = Hi),
  (na.all = function (e) {
    return new na(function (t, n) {
      if (!ea(e)) return n(new TypeError('Promise.all accepts an array'));
      var r = Array.prototype.slice.call(e);
      if (0 === r.length) return t([]);
      var o = r.length;
      function i(e, a) {
  ...
  (na.allSettled = qi),
  (na.resolve = function (e) {
    return e && 'object' == typeof e && e.constructor === na
      ? e
      : new na(function (t) {
          t(e);
        });
  }),
  (na.reject = function (e) {
    return new na(function (t, n) {
      n(e);
    });
  }),
  (na.race = function (e) {
    return new na(function (t, n) {
      if (!ea(e)) return n(new TypeError('Promise.race accepts an array'));
      for (var r = 0, o = e.length; r < o; r++) na.resolve(e[r]).then(t, n);
    });
  }),
  (na._immediateFn =
    ('function' == typeof $i &&
  ...
  (na._unhandledRejectionFn = function (e) {
...
'function' != typeof ua.Promise
  ? (ua.Promise = na)
  : (ua.Promise.prototype.finally || (ua.Promise.prototype.finally = Hi),
    ua.Promise.allSettled || (ua.Promise.allSettled = qi)),
  (function (e) {
    function t() {}
    function n(e, t) {
      if (
...
var fa = l(function (e, t) {
                ...
                case 0:
                  return (
                    ...
                    null === (a = n.getItem(i))
                      ...
                      ? [3, 2]
                      : [4, la.default().lock(a.iat)]
                  );
                case 1:
                  r.sent(),
                    this.acquiredIatSet.delete(a.iat),
                    n.removeItem(i),
                    la.default().unlock(a.iat),
                    e.notifyWaiters(),
                    (r.label = 2);
                case 2:
                  return [2];
  ...
  ya = { name: 'authok-spa-js', version: '1.19.4' },
  va = function () {
    return Date.now();
  },
  ma = (function (e) {
      ...
      (r = function (a) {
        if (a.data && 'authorization_response' === a.data.type) {
          if (
            ...
            return n(ma.fromPayload(a.data.response));
          t(a.data.response);
        }
      }),
  ...
  Oa = function () {
    var e =
      ...
      t = '';
    return (
      Array.from(Ia().getRandomValues(new Uint8Array(43))).forEach(function (
        n
      ) {
...
var Aa = function (e, t) {
  ...
  Pa = function (e, t, n, r, a, c, s) {
    return (
      void 0 === s && (s = 1e4),
      o(void 0, void 0, void 0, function () {
        return i(this, function (o) {
          return a ? [2, Ka(e, t, n, r, s, a, c)] : [2, Ua(e, r, s)];
        });
      })
    );
  };
function Fa(e, t, n, a, c, s, u) {
    ...
    return i(this, function (i) {
      switch (i.label) {
        ...
        case 1:
          ...
          i.label = 2;
        case 2:
          return i.trys.push([2, 4, , 5]), [4, Pa(e, n, a, c, s, u, t)];
        case 3:
        ...
        case 6:
          ...
          if (
            ...
            if (
              ...
              throw new ka(p, m, v.mfa_token);
            throw new ma(p || 'request_error', m);
          }
          return [2, v];
      }
    });
                ...
                s,
                {
                  ...
                  headers: {
                    'Content-Type': l
                      ...
                      : 'application/json',
                    'Authok-Client': btoa(JSON.stringify(u || ya)),
                  },
                },
                t,
                l
...
var La = function (e) {
  ...
  Za = function () {
    ...
    return La(e.join(' ').trim().split(/\s+/)).join(' ');
  },
  Ga = (function () {
    function e(e, t) {
      void 0 === t && (t = '@@authokspajs@@'),
        (this.prefix = t),
    ...
    return (
      ...
      (e.prototype.allKeys = function () {
        return Object.keys(window.localStorage).filter(function (e) {
          return e.startsWith('@@authokspajs@@');
        });
      }),
      e
    );
  ...
  Na = (function () {
    function e(e, t, n) {
      (this.cache = e),
        (this.keyManifest = t),
        (this.nowProvider = n),
        (this.nowProvider = this.nowProvider || va);
    }
    return (
  ...
  Ba = function (e) {
    ...
    var t = (function (e) {
      ...
      var c = JSON.parse(Ra(o)),
        s = { __raw: e },
        u = {};
      return (
        Object.keys(c).forEach(function (e) {
          (s[e] = c[e]), za.includes(e) || (u[e] = c[e]);
        }),
        {
          encoded: { header: r, payload: o, signature: i },
          header: JSON.parse(Ra(r)),
          claims: s,
          user: u,
        }
      );
    ...
    if (e.max_age && !Da(t.claims.auth_time))
      throw new Error(
...
u(Ja), Ja.encode, Ja.parse, Ja.getAll;
var Ma = Ja.get,
  Ha = Ja.set,
  qa = Ja.remove,
  Qa = {
  ...
  $a = {
    get: function (e) {
      var t = Qa.get(e);
      return t || Qa.get(''.concat('_legacy_').concat(e));
    },
    save: function (e, t, n) {
      var r = {};
      'https:' === window.location.protocol && (r = { secure: !0 }),
        (null == n ? void 0 : n.daysUntilExpire) &&
          (r.expires = n.daysUntilExpire),
        Ha(''.concat('_legacy_').concat(e), JSON.stringify(t), r),
        Qa.save(e, t, n);
    },
    remove: function (e) {
      Qa.remove(e), Qa.remove(''.concat('_legacy_').concat(e));
    },
  },
  ec = {
    get: function (e) {
...
var nc,
  ...
  ac =
    ...
    (oc = !1),
    function (e) {
      return (ic = ic || tc(nc, rc, oc)), new Worker(ic, e);
    }),
  cc = {},
  sc = (function () {
    function e(e, t) {
    ...
    return (
      ...
      (e.prototype.createManifestKeyFrom = function (e) {
        return ''.concat('@@authokspajs@@', '::').concat(e);
      }),
      e
    );
  })(),
    ...
    function e(e) {
      ...
      if (
        ...
        if (
          ...
          !fc(this.cacheLocation))
        )
          throw new Error(
            'Invalid cache location "'.concat(this.cacheLocation, '"')
          );
        o = fc(this.cacheLocation)();
      }
      (this.cookieStorage = !1 === e.legacySameSiteCookie ? Qa : $a),
      ...
      var a,
        c = e.useCookiesForTransactions ? this.cookieStorage : ec;
      (this.scope = this.options.scope),
        (this.transactionManager = new Ya(c, this.options.client_id)),
        (this.nowProvider = this.options.nowProvider || va),
        (this.cacheManager = new Na(
          o,
          o.allKeys ? null : new sc(o, this.options.client_id),
          this.nowProvider
        )),
        (this.domainUrl =
        ...
        this.options.useRefreshTokens &&
          (this.scope = Za(this.scope, 'offline_access')),
        'undefined' != typeof window &&
          window.Worker &&
          this.options.useRefreshTokens &&
    ...
    return (
      (e.prototype._url = function (e) {
        var t = encodeURIComponent(
          btoa(JSON.stringify(this.options.authokClient || ya))
        );
        return ''.concat(this.domainUrl).concat(e, '&authokClient=').concat(t);
      }),
      (e.prototype._getParams = function (e, t, o, i, a) {
        ...
        return n(n(n({}, s), e), {
          scope: Za(this.defaultScope, this.scope, e.scope),
          response_type: 'code',
          response_mode: 'query',
          state: t,
          nonce: o,
      ...
      (e.prototype._authorizeUrl = function (e) {
        return this._url('/authorize?'.concat(xa(e)));
      }),
              ...
              switch (o.label) {
                case 0:
                  return (
                    ...
                    (n = Za(this.defaultScope, this.scope, e.scope)),
                    [
                      4,
            ...
            switch (n.label) {
              case 0:
                if (!this.cookieStorage.get(this.isAuthenticatedCookieName)) {
                  if (!this.cookieStorage.get('authok.is.authenticated'))
                    return [2];
                  this.cookieStorage.save(this.isAuthenticatedCookieName, !0, {
                    daysUntilExpire: this.sessionCheckExpiryDays,
                  }),
                    this.cookieStorage.remove('authok.is.authenticated');
                }
                n.label = 1;
              case 1:
              ...
              case 2:
                return n.sent(), [3, 4];
              case 3:
                if (((t = n.sent()), !pa.includes(t.error))) throw t;
                return [3, 4];
              case 4:
                return [2];
            }
              ...
              switch (p.label) {
                ...
                case 2:
                  return [
                    4,
                    ((y = function () {
                      return uc.acquireLock(
                        'authok.lock.getTokenSilently',
                        5e3
                      );
                    }),
                    (v = 10),
                ...
                case 12:
                  return [4, uc.releaseLock('authok.lock.getTokenSilently')];
                case 13:
                  return p.sent(), [7];
                case 14:
                  return [3, 16];
              ...
              switch (r.label) {
                case 0:
                  return (
                    ...
                    (e.scope = Za(this.defaultScope, this.scope, e.scope)),
                    (t = n(n({}, ha), t)),
      ...
      (e.prototype.buildLogoutUrl = function (e) {
        ...
        var t = e.federated,
          n = r(e, ['federated']),
          o = t ? '&federated' : '';
        return this._url('/v1/logout?'.concat(xa(n))) + o;
      }),
      ...
      (e.prototype._getTokenFromIFrame = function (e) {
        return o(this, void 0, void 0, function () {
          ...
          return i(this, function (i) {
            switch (i.label) {
              case 0:
                return (t = Ea(Oa())), (o = Ea(Oa())), (a = Oa()), [4, Ca(a)];
              case 1:
                (c = i.sent()),
                  (s = ja(c)),
                      ...
                      if (
                        ...
                        a && a.close(),
                          n.data.response.error
                            ? t(ma.fromPayload(n.data.response))
                            : e(n.data.response),
                          clearTimeout(i),
                          window.removeEventListener('message', r, !1),
                          setTimeout(o, 2e3);
            ...
            switch (i.label) {
              case 0:
                return [
                  4,
                  this.cacheManager.get(
                    new Ga({ scope: t, audience: r, client_id: a }),
                    60
                  ),
                ];
              case 1:
...
function yc(e) {
  return o(this, void 0, void 0, function () {
    ...
    return i(this, function (n) {
      switch (n.label) {
        case 0:
          return [4, (t = new hc(e)).checkSession()];
        case 1:
          return n.sent(), [2, t];
      }
    });
...
export {
  ga as AuthenticationError,
  hc as AuthokClient,
  ma as GenericError,
  Va as InMemoryCache,
  Xa as LocalStorageCache,
  ka as MfaRequiredError,
  Sa as PopupCancelledError,
  wa as PopupTimeoutError,
  ba as TimeoutError,
  pc as User,
  yc as default,
};
//# sourceMappingURL=authok-spa-js.production.esm.js.map
