...
var AuthokClient = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this._verifyIdToken(authResult.id_token, nonceIn, organizationId),
            ];
          case 4:
  ...
  AuthokClient.prototype.buildLogoutUrl = function (options) {
    ...
    var url = this._url('/v1/logout?'.concat(createQueryParams(logoutOptions)));
...
//# sourceMappingURL=authok-spa-js.cjs.js.map
